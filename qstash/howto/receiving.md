...
​
Headers
We are forwarding all headers that have been prefixed with `Upstash-Forward-` to your API. Learn more In addition to your custom headers, we’re sending these headers as well: Header| Description  
---|---  
...
`Upstash-Signature`| The signature you need to verify See here  
...
Handling FailuresUse as Webhook Receiver
Assistant
