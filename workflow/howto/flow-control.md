On this page
`Flow Control` enables you to limit the number of calls made to your workflow by delaying the delivery. There are two main use cases for Flow-Control in Workflow:
...
Secure an EndpointParallel Runs
Assistant
