Logs of the Workflow can be found in the console under the Workflow tab It has two modes that can be changed from to top right corner:
...
Waiting for EventsSecure an Endpoint
Assistant
