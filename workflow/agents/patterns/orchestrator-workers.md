...
If you wish to manually use the model results instead of utilizing a manager LLM as we did in this example, see the parallelization example In response to the prompt, the agents create the following response:
Copy
Ask AI
```
### Quantum Mechanics
