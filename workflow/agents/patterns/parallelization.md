...
You can also see how the same thing can be achieved using an manager agent in orchestrator-workers example. In response to the prompt, our agents generate this response:
Copy
Ask AI
```
...
Evaluator-OptimizerOrchestrator-Workers
Assistant
