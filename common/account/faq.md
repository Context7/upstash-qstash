...
You can change your account e-mail address in `Account` > `Settings` page. In order to change your billing e-mail adress, please see `Account` > `Billing` page. If you encounter any issues, please contact us at support@upstash.com to change your email address.
## 
​
Can I set an upper spending limit, so I don’t get surprises after an unexpected amount of high traffic?
On Pay as You Go model, you can set a budget for your Redis instances. When your monthly cost reaches the max budget, we send an email to inform you and throttle your instance. You will not be charged beyond your set budget. To set the budget, you can go to the “Usage” tab of your Redis instance and click “Change Budget” under the cost metric.
## 
​
...
Please contact us at support@upstash.com.
Was this page helpful?
YesNo
Suggest editsRaise issue
Audit LogsSupport & Contact Us
Assistant
