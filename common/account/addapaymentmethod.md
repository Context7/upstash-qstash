...
You can enter multiple credit cards and set one of them as the default one. The payments will be charged from the default credit card.
## 
​
Payment Security
Upstash does not store users’ credit card information in its servers. We use Stripe Inc payment processing company to handle payments. You can read more about payment security in Stripe here.
Was this page helpful?
YesNo
Suggest editsRaise issue
Developer APIAWS Marketplace
Assistant
