...
Open your browser and navigate to `http://localhost:3000` to test the application. You can search through Upstash docs, and results will redirect you to the page you are looking for.
* * *
### 
​
Next Steps
...
Next.js Search QuickstartSearchBar
Assistant
