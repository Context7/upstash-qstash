...
Open your browser and navigate to `http://localhost:3000` to test the application. You can click the `Upsert Data` button to add three movies to your database and use the search bar to make a query.
* * *
### 
​
Next Steps
...
Pricing & LimitsDocs Search Quickstart
Assistant
